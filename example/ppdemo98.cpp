...
int main(int argc, char * argv[])
{
  ...
  std::cout << pprint::print_container_helper<std::vector<std::string>, char, std::char_traits<char>, MyDelims>(v) << std::endl;

  /* Demo: Here we achieve the same using a type-erasing helper class. */
  std::cout << pprint::custom_delims<MyDelims>(v) << std::endl;
